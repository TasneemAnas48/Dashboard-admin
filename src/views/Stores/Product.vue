            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center add">
                        المنتجات
                        <!-- <router-link to="/store/" + store_id> -->
                            <b-button class="button-view" @click="ret">عودة</b-button>
                        <!-- </router-link> -->
                    </div>
                </div>
                <div class="card-body">
...
export default {
    ...
    methods: {
        ...
        getData() {
            this.axios.get("http://" + this.$store.state.ip + "api/product/collection/index/" + this.group_id)
                .then(res => {
                    this.rows = res.data
        ...
        ret(){
            this.$router.replace({ name: 'store' , params: { id: this.store_id} })
        },
    },
    mounted() {
